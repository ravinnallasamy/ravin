        ...
        {organizations.map((org) => (
          <li key={org.id}>
            <a
              ...
              className="flex flex-col items-center gap-8 rounded-2xl border border-border/50 bg-surface p-16 text-center transition-colors hover:border-accent"
            >
              <img src={org.avatarUrl} alt="" className="h-40 w-40 rounded-full" loading="lazy" />
              <span className="text-mono-label font-mono text-ink">{org.login}</span>
              {org.description && (
